...
public class FarmingFeatureConfigs {
	...
	public static final class States {
		...
		private static final BlockState APPLE_SAPLING = FarmingRegistry.APPLE_SAPLING.get().defaultBlockState();
		private static final BlockState LEMON_SAPLING = FarmingRegistry.LEMON_SAPLING.get().defaultBlockState();
		private static final BlockState ORANGE_SAPLING = FarmingRegistry.ORANGE_SAPLING.get().defaultBlockState();
		private static final BlockState CHERRY_SAPLING = FarmingRegistry.CHERRY_SAPLING.get().defaultBlockState();
		private static final BlockState PEAR_SAPLING = FarmingRegistry.PEAR_SAPLING.get().defaultBlockState();
		private static final BlockState BANANA_SAPLING = FarmingRegistry.BANANA_SAPLING.get().defaultBlockState();
		private static final BlockState AVOCADO_SAPLING = FarmingRegistry.AVOCADO_SAPLING.get().defaultBlockState();
		private static final BlockState MANGO_SAPLING = FarmingRegistry.MANGO_SAPLING.get().defaultBlockState();
		private static final BlockState OLIVE_SAPLING = FarmingRegistry.OLIVE_SAPLING.get().defaultBlockState();

		private static final BlockState APPLE_LEAVES = FarmingRegistry.APPLE_LEAVES.get().defaultBlockState();
		private static final BlockState LEMON_LEAVES = FarmingRegistry.LEMON_LEAVES.get().defaultBlockState();
		private static final BlockState ORANGE_LEAVES = FarmingRegistry.ORANGE_LEAVES.get().defaultBlockState();
		private static final BlockState CHERRY_LEAVES = FarmingRegistry.CHERRY_LEAVES.get().defaultBlockState();
		private static final BlockState PEAR_LEAVES = FarmingRegistry.PEAR_LEAVES.get().defaultBlockState();
		private static final BlockState BANANA_LEAVES = FarmingRegistry.BANANA_LEAVES.get().defaultBlockState();
		private static final BlockState AVOCADO_LEAVES = FarmingRegistry.AVOCADO_LEAVES.get().defaultBlockState();
		private static final BlockState MANGO_LEAVES = FarmingRegistry.MANGO_LEAVES.get().defaultBlockState();
		private static final BlockState OLIVE_LEAVES = FarmingRegistry.OLIVE_LEAVES.get().defaultBlockState();
